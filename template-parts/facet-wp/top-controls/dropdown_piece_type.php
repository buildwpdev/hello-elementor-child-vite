...
<div class="relative group inline-block">
  <button 
    data-dropdown-toggle="dropdown-filter-piece_type" 
  ...
  <!-- Dropdown menu -->
  <div 
    id="dropdown-filter-piece_type" 
    class="z-10 hidden group-hover:block bg-stone-100 border border-stone-300 divide-y divide-stone-200 shadow-sm w-56 p-3 dark:bg-stone-800 dark:border-stone-700 dark:divide-stone-600"
  >
      <div class="flex flex-col space-y-2">
          <?php echo facetwp_display('facet', 'shop_by_piece_type'); ?>
      </div>
  </div>
</div>
